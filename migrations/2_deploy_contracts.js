// var ContractCP = artifacts.require("ContractCP.sol");
var ContractCPList = artifacts.require("ContractCPList.sol");

// var ContractPI = artifacts.require("ContractPI.sol");
var ContractPIList = artifacts.require("ContractPIList.sol");

module.exports = function(deployer) {
  // deployer.deploy(ContractCPList).then(()=> deployer.deploy(ContractPIList));
  deployer.deploy(ContractCPList);
  deployer.deploy(ContractPIList);
}
