...
contract ContractPI {
   ...
   /**
    ...
    function ContractPI(address inInusrer, address inPatient, address inInsurerCategory) {
    ...
    function patientConfirm(uint inPackId, uint inNumberOfMonths, uint inStartDate, uint inContractValue) payable minimumAmount(inContractValue) {
        ...
        uint totalContractValue = _insuranceCategory.calculateContractValue(inPackId, inNumberOfMonths);
